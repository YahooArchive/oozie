...
public class BundleStore extends Store{
   ...
   /**
    * Load the BundleJob into a Bean and return it. Also load the bundle Instance into the bean. And lock the
    * bundle depending on the locking parameter.
    *
    * @param id Job ID
   ...
   public List<BundleJobBean> getBundleJobsOlderThanStatus(final long checkAgeSecs, final String status,
       ...
       List<BundleJobBean> bjBeans = doOperation("getBundleOlderThanStatus",
			                                 new Callable<List<BundleJobBean>>() {

 ...
 */
public class WorkflowActionSubsetGetCommand implements JPACommand<List<WorkflowActionBean>> {
     ...
     * @param length
     */
    public WorkflowActionSubsetGetCommand(String wfId, int start, int length) {

...
public class WorkflowsJobGetCommand implements JPACommand<WorkflowsInfo> {
     ...
     * @param len
     */
    public WorkflowsJobGetCommand(Map<String, List<String>> filter, int start, int len) {
        this.filter = filter;
        this.start = start;
        this.len = len;
    }
    ...
    @Override
    public WorkflowsInfo execute(EntityManager em) throws CommandException {

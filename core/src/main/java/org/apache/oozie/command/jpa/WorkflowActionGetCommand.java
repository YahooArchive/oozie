 ...
 */
public class WorkflowActionGetCommand implements JPACommand<WorkflowActionBean> {

    private String wfActionId = null;

    public WorkflowActionGetCommand(String wfActionId) {
    ...
    public WorkflowActionBean execute(EntityManager em) throws CommandException {
        ...
        if (waBeans != null && waBeans.size() > 0) {
            ...
            throw new CommandException(ErrorCode.E0605, wfActionId);
        }
    }

 ...
 */
public class CoordJobInfoGetCommand implements JPACommand<CoordinatorJobInfo> {

    private Map<String, List<String>> filter;
    private int start = 1;
    private int len = 50;

    public CoordJobInfoGetCommand(Map<String, List<String>> filter, int start, int len) {
    ...
    public CoordinatorJobInfo execute(EntityManager em) throws CommandException {

...
public class TestJavaActionExecutor extends ActionExecutorTestCase {
    ...
    public void testCredentialsModule() throws Exception {
        String actionXml = "<workflow-app xmlns='uri:oozie:workflow:0.2.5' name='pig-wf'>"+
            "<authentications>"+
    ...
    "</pig>";
     ...
     // Setting the authentication properties in launcher conf
        HashMap<String,CredentialsProperties> authProperties = ae.setAuthenticationPropertyToActionConf(context, action,actionConf);

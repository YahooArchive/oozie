...
These scripts does 2 things: The first one will install a modified documentation plugin with better twiki support. The second one will install JARs in the local Maven repository that are not available in public Maven repositories.

...
Oozie - Yahoo!(tm)'s workflow engine for Apache Hadoop(tm) is an open-source workflow solution to manage and coordinate jobs running on Hadoop, including HDFS, Pig and MapReduce.
...
The source for Oozie can be obtained from "github":http://github.com/yahoo/oozie/tarball/oozie-2.0.2.1. It can also be accessed via git from the "source repository":http://github.com/yahoo/oozie.

Users may communicate with each other and Yahoo! on Oozie user's mailing list:

"oozie-users@yahoogroups.com":mailto:oozie-users@yahoogroups.com

h2(#notices).  Credits & Notices

* Yahoo! does not offer any support for Oozie - Yahoo!'s workflow engine for Hadoop..

h2(#ack). Acknowledgments 
